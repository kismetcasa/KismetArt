...
// The JWK never leaves the server — only the deepHash (48 bytes, SHA-384) is
// sent to /api/sign. Auth is the httpOnly session cookie (set by /api/session),
// which fetch() includes automatically on same-origin requests.
