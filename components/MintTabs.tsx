  ...
  return (
    <div>
      ...
      {tab === 'mint' && (
        <>
          {deployedCollection && (
            <div className="mb-6 p-3 border border-[#d4f53c]/30 bg-[#d4f53c]/5 flex items-center justify-between gap-4">
              <div>
                <p className="text-xs font-mono text-[#d4f53c]">minting into: {deployedCollection.name}</p>
